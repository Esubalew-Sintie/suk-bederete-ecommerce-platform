...
export default function CreateCustomComponent() {
    ...
    <div id="iooi" class="container-width">
      <div class="logo-container">
        <div id="ieen" class="logo">GrapesJS
        </div>
      </div>
      <nav id="i48i" class="menu">
        <div id="ivh5" class="menu-item">BUILDER
        </div>
        <div id="ite9" class="menu-item">TEMPLATE
        </div>
        <div id="itsya" class="menu-item">WEB
        </div>
      </nav>
      <div class="clearfix">
      </div>
      <div id="i1aou" class="lead-title">Build your templates without coding
      </div>
      <div id="i02mi" class="sub-lead-title">All text blocks could be edited easily with double clicking on it. You can create new text blocks with the command from the left panel
      </div>
      <div class="lead-btn">Hover me
      </div>
    </div>
  </header>
  <section id="ii6qi" class="flex-sect">
    <div class="container-width">
      ...
      <div class="cards">
        ...
        <div class="card">
          <div id="ihbe4" class="card-header ch3">
          </div>
          <div class="card-body">
            <div id="i0y4l" class="card-title">Title three
            </div>
  ...
  <section id="ivgc2" class="am-sect">
    <div class="container-width">
      <div id="i1zqy" class="am-container">
        <img src="./img/phone-app.png" id="ix6nk" class="img-phone"/>
        <div class="am-content">
          <div id="imot3" class="am-pre">ASSET MANAGER
          </div>
          <div id="ihsj6" class="am-title">Manage your images with Asset Manager
          </div>
          <div id="ibwen" class="am-desc">You can create image blocks with the command from the left panel and edit them with double click
          </div>
          <div id="io9fk" class="am-post">Image uploading is not allowed in this demo
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="price-cards">
        ...
        <div class="price-card-cont">
          <div class="price-card pc-regular">
            <div id="io0hmy" class="pc-title">Regular
            </div>
            <div class="pc-desc">Some random list
            </div>
        ...
        <div class="price-card-cont">
          <div class="price-card pc-enterprise">
            ...
            <div id="ih98tq" class="pc-feature">+ Enterprise feature 2
            </div>
    ...
    <div class="container-width">
      ...
      <div class="badges">
        ...
        <div class="badge">
          ...
          <img src="img/team3.jpg" id="ijeq8j" class="badge-avatar"/>
          <div class="badge-body">
            <div id="ibcqf2" class="badge-name">Jessica White
            </div>
          ...
          <div class="badge-foot">
            <span id="iw5wi6" class="badge-link">f</span>
            <span id="i6prq1" class="badge-link">t</span>
            <span class="badge-link">ln</span>
          </div>
        </div>
      </div>
  ...
  <footer class="footer-under">
    <div class="container-width">
      <div id="i0glv2" class="footer-container">
        <div class="foot-lists">
          ...
          <div class="foot-list">
            ...
            <div id="inmiyh" class="foot-list-item">Download
            </div>
