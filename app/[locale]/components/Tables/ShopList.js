								...
								return (
									...
									>
										...
										<TableCell
											...
											scope="row"
                                            padding="none"
                                            sx={{ color: 'text-blueGray-500' }}
										>
											{row?.name}
										</TableCell>
										<TableCell align="left" sx={{ color: 'text-blueGray-500' }}>{row.unique_id}</TableCell>
										<TableCell align="left" sx={{ color: 'text-blueGray-500' }}>
											{row.customized_template}
										</TableCell>
										<TableCell align="left" sx={{ color: 'text-blueGray-500' }}>{row?.created_date}</TableCell>
										<TableCell align="left" sx={{ color: 'text-blueGray-500' }}>{row?.Action}</TableCell>
									</TableRow>
								);
							})}
							{emptyRows > 0 && (
