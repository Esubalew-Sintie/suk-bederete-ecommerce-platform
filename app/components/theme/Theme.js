	...
	return (
		<div className=" w-80  text-black pb-6 bg-blueGray-200 border rounded-md">
			...
			<div className=" flex justify-between mt-2 mx-1">
				...
				<Link  href={`site-builder/${theme.id}`} className="bg-blueGray-800 text-white hover:bg-blue-200 h-8 active:bg-blueGray-600  active:bg-opacity-100 text-sm font-bold uppercase px-3  rounded shadow hover:shadow-lg outline-none  focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150">
					Select{" "}
				</Link>
			</div>
		</div>
