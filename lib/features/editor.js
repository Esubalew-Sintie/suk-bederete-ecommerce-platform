...
import dynamicConfig from '../../app/components/sitebuilder/WithGrapesjs'// Ensure this path is correct

// Async thunk for initializing the GrapesJS editor
export const initEditor = createAsyncThunk('editor/init', async (_, { rejectWithValue }) => {
  try {
