...
export const webBuilder = createApi({
  ...
  endpoints: (builder) => ({
    ...
    getPageContent: builder.query({
      query: (templteId) => `/getTemplatePages/${templteId}/`,
      providesTags: ["WebBuilders"],

    }),
    getPage: builder.query({
      query: ({ templateId, pageId }) => `/getPage/${templateId}/${pageId}/`,
      providesTags: ["WebBuilders"],
     }),
    ...
    updatePageContent: builder.mutation({
      query: ({templateId, page_id, ...content}) => ({
        url: `/updatePageContent/${templateId}/${page_id}/`,
        method: "PATCH",
        body:content
...
export const {useGetWebBuildersQuery,useUpdatePageContentMutation, useGetWebBuilderQuery, useGetPageContentQuery, useGetPageQuery, useUpdateTemplateMutation,useAddTemplateMutation,useDeleteTemplateMutation,useGetTemplatePagesQuery} = webBuilder;
